...
import {convertToCastString, convertToCastInfo} from '../../utils/util'
const app = getApp()
Page({
    ...
    processMovieData(movie){
        const data = {}
        data.director = convertToCastString(movie.directors)
